...
```text
Languages      Python, Swift, JavaScript, SQL, C++, Java
AI & Data      PyTorch, TensorFlow, OpenAI, LangChain, Hugging Face, scikit-learn, OpenCV
Cloud & Infra  AWS (ECS, Fargate, ECR, Bedrock, S3), Docker, GitHub Actions, Supabase
Backend        FastAPI, Flask, Django, Node.js, PostgreSQL, MongoDB, OpenSearch
Frontend       SwiftUI, React, HTML/CSS
```
